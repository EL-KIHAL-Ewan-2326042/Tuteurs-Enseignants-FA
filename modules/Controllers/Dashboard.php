        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            if (isset($_FILES['csv_file_student'])){
                ...
                $headers = match ($table) {
                    ...
                    'is_responsible' => ['id_teacher','student_number','distance_minute','relevance_store','responsible_start_date','responsible_end_date'],
                    'has_address' => ['id_teacher','address','adr_type'],
                    'address_type' => ['adr_type'],
                    'addr_name' => ['address'],
                    'has_role' => ['user_id','role_name','role_department'],
                    'role' => ['role_name'],
                    'user_connect' => ['user_id','uer_pass'],
