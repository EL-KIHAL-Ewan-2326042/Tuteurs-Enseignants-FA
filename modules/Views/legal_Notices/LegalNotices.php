        ...
        <main>
            <div class="column">
                ...
                <p>Le directeur de la publication est une personne physique
                    ...
                    les informations sur l'éditeur, mais uniquement dans le cadre
                    d'une procédure judiciaire.</p>
                ...
                <p>L'ensemble de ce site Web relève des législations françaises et
                    internationales sur le droit d'auteur et la propriéte
                    ...
                    <br>
                    Selon <a href=
                             "https://fr.wikipedia.org/wiki/Convention_de_Berne_pour
_la_protection_des_%C5%93uvres_litt%C3%A9raires_et_artistiques">
                    ...
                    les oeuvres ayant pour pays d'origine l'un des États
                    contractants, c'est-à-dire dont l'auteur est un ressortissant
                    d'un des États de l'union, doivent bénéficier dans chacun
                    des autres États contractants de la même protection que celle
                    que cet État accorde aux oeuvres de ses propres nationaux. <br>
...
Tuteurs-Enseignants/edit/main/LICENSE">
                ...
                <p>Soucieux du respect de la vie privée des utilisateurs du site
                    ...
                    Pour exercer ses droits, l'utilisateur
                    peut demander la suppression de son compte ou
                    des données collectées auprès de l'éditeur
                ...
                <p>L'utilisateur qui constaterait des inexactitudes, des
                    informations erronées ou des informations
                    de caractère manifestement illicite,
                    est tenu d'en informer le responsable
